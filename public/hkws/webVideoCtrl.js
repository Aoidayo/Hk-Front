  ...
  window.WebVideoCtrl || (e = function () {
    function e(i) {
      return new Promise(function (t, n) {
        var e;
        g.isUndefined(i) || (s.szContainerID = i), null == document.getElementById(s.szContainerID) ? n(M) : (e = {
          szId: i,
          iType: 1,
          iWidth: "100%",
          iHeight: "100%",
          ...
          onConnectSuccess: () => {
            var e = $("#" + i);
            p.JS_Resize(e.width(), e.height()), 2 !== p.iPluginMode ? n({
              errorCode: 3e3,
              errorMsg: "Plugin init failed."
            }) : (e = s.bWndFull ? 1 : 0, p.JS_SetFullScreenCapability(e), p.JS_SetPackageType(s.iPackageType), p.JS_SetWindowControlCallback({
      ...
      return new Promise((o, e) => {
        ...
        t.oProtocolInc.getPortInfo(t, {
          async: !1, success: function (e) {
            ...
            r = 554;
            for (var n = 0, i = t.length; n < i; n++) "rtsp" === H.$XML(t).eq(n).find("protocol").eq(0).text().toLowerCase() && (r = parseInt(H.$XML(t).eq(n).find("portNo").eq(0).text(), 10)), "http" === H.$XML(t).eq(n).find("protocol").eq(0).text().toLowerCase() && (s = parseInt(H.$XML(t).eq(n).find("portNo").eq(0).text(), 10)), "dev_manage" === H.$XML(t).eq(n).find("protocol").eq(0).text().toLowerCase() && (a = parseInt(H.$XML(t).eq(n).find("portNo").eq(0).text(), 10));
    ...
    function d(t) {
      return new Promise((o, e) => {
        ...
        t.oProtocolInc.getUPnPPortStatus(t, {
          async: !1, success: function (e) {
            for (var t = H.$XML(e).find("portStatus", !0), n = 0, i = t.length; n < i; n++) "rtsp" == H.$XML(t).eq(n).find("internalPort").eq(0).text().toLowerCase() && (r = parseInt(H.$XML(t).eq(n).find("externalPort").eq(0).text(), 10)), "http" == H.$XML(t).eq(n).find("internalPort").eq(0).text().toLowerCase() && (s = parseInt(H.$XML(t).eq(n).find("externalPort").eq(0).text(), 10)), "admin" == H.$XML(t).eq(n).find("internalPort").eq(0).text().toLowerCase() && (a = parseInt(H.$XML(t).eq(n).find("externalPort").eq(0).text(), 10));
            o({iRtspPort: r, iHttpPort: s, iDevicePort: a})
          }, error: function () {
            o({iRtspPort: -1, iHttpPort: -1, iDevicePort: -1})
          }
    ...
    function u(e) {
      return new Promise(function (t) {
        ...
        e.oProtocolInc.getPPPoEStatus(e, {
          success: function (e) {
            n = 0 < H.$XML(e).find("ipAddress", !0).length || 0 < H.$XML(e).find("ipv6Address", !0).length, t(n)
          }, error: function () {
            t(n = !1)
          }
        })
    ...
    function l(c, u, l, p, h, I, f, P) {
      ...
      return g.extend(e, P), g.extend(e, {
        success: function (e) {
          var t, n, i, o, r, s, a, d;
          t = c, i = l, o = p, r = h, s = I, a = f, (n = u).szIP = i, 2 == o ? (n.szHttpProtocol = "https://", n.iHttpsPort = r) : (n.szHttpProtocol = "http://", n.iHttpPort = r), n.iCGIPort = r, n.szDeviceIdentify = i + "_" + r, n.iDeviceProtocol = y, n.oProtocolInc = t, n.szAuth = g.Base64.encode(":" + s + ":" + a), m.push(u), d = u, new Promise(function (e, t) {
            var n = d.oProtocolInc.getDeviceInfo(d, {}), i = d.oProtocolInc.getAnalogChannelInfo(d, {}),
              o = d.oProtocolInc.getAudioInfo(d, {}), r = b(d), s = d.oProtocolInc.getDeviceMinusLocalTime(d);
    ...
    var s = {
      ...
      }, p = null, h = 0, t = !1, m = [], I = [], f = null, g = null, P = this, S = null, y = 1, o = 1e3, r = 3002,
      x = 3003, C = 3004, v = 5e3, q = 0, T = "IPCamera", D = "IPDome", w = "IPZoom", B = function (e) {
        h = e, s.cbSelWnd && ((e = []).push("<RealPlayInfo>"), e.push("<SelectWnd>" + h + "</SelectWnd>"), e.push("</RealPlayInfo>"), s.cbSelWnd(g.loadXML(e.join(""))))
      }, k = function (e) {
        s.cbDoubleClickWnd && 2 === e.eventType && (s.bWndFull && -1 != P.findWndIndexByIndex(e.wndIndex) && (t = !t), s.cbDoubleClickWnd(e.wndIndex, t))
      }, Z = function (e, t, n) {
        var i = o;
        0 === t ? i = r : 2 === t ? i = x : 3 === t ? i = v : 21 === t && (i = C), r == i || x == i ? P.I_Stop(e) : C == i ? P.I_StopRecord(e) : v == i && P.I_StopVoiceTalk(), s.cbEvent && s.cbEvent(i, e, n)
      }, X = function (e) {
        100 === parseInt(e, 10) && (t = !1, s.cbDoubleClickWnd) && s.cbDoubleClickWnd(h, t)
      }, _ = {errorCode: 2e3, errorMsg: "The device is not login."}, z = {errorCode: o, errorMsg: "Unknown error."},
      M = {errorCode: 1002, errorMsg: "Params error."}, b = function (s) {
        return new Promise(async (e, t) => {
          var n = null;
          if (await u(s)) n = await a(s); else {
            for (var i = await c(s), o = !1, r = 0; r < i.length; r++) if (i[r].ipv4 == s.szIP || i[r].ipv6 == s.szIP) {
              o = !0;
              break
            }
            (o || -1 == (n = await d(s)).iRtspPort && -1 == n.iDevicePort) && (n = await a(s))
          }
    ...
    function U() {
      this.szIP = "", this.szHostName = "", this.szAuth = "", this.szHttpProtocol = "http://", this.iCGIPort = 80, this.szDeviceIdentify = "", this.iDevicePort = -1, this.iHttpPort = -1, this.iHttpsPort = -1, this.iRtspPort = -1, this.iAudioType = 1, this.m_iAudioBitRate = -1, this.m_iAudioSamplingRate = -1, this.iDeviceProtocol = y, this.oProtocolInc = null, this.iAnalogChannelNum = 0, this.szDeviceType = "", this.bVoiceTalk = !1, this.iDeviceMinusLocalTime = 0
    }
    ...
    this.I_SupportNoPlugin = function () {
      ...
      !e || "object" == typeof exports && "undefined" != typeof module || ("function" == typeof define && define.amd ? require([e + "/jsVideoPlugin-1.0.0.min.js"], function (e) {
        ...
        var e;
        null !== p && (e = $("#" + s.szContainerID), p.JS_Resize(e.width(), e.height()))
      }), window.addEventListener("unload", function () {
      })
    }, this.I_InsertOBJECTPlugin = e, this.I_WriteOBJECT_XHTML = function () {
      return 0
      ...
      return new Promise(function (e, t) {
        var n, i;
        -1 != this.findDeviceIndexByIP(o + "_" + s) ? (c.error && c.error({
          errorCode: 2001,
          errorMsg: "The device is already login."
        }), t({
          errorCode: 2001,
          errorMsg: "The device is already login."
        })) : (n = f, i = new U, l(n, i, o, r, s, a, d, c).then(() => {
          e()
        }, e => {
          t(e)
        }))
      ...
      return new Promise(function (t, n) {
        ...
        -1 != e ? (e = m[e]).oProtocolInc.getAudioInfo(e, o).then(e => {
          t(e)
        }, e => {
          n(e)
        }) : n(_)
      ...
      return new Promise(function (t, n) {
        var e = this.findDeviceIndexByIP(i);
        -1 != e ? (e = m[e]).oProtocolInc.getDeviceInfo(e, o).then(e => {
          t(e)
        }, e => {
          n(e)
        }) : n(_)
      ...
      return new Promise(function (t, n) {
        var e = this.findDeviceIndexByIP(i);
        -1 != e ? (e = m[e]).oProtocolInc.getAnalogChannelInfo(e, o).then(e => {
          t(e)
        }, e => {
          n(e)
        }) : n(_)
      ...
      return new Promise(function (t, n) {
        var e = this.findDeviceIndexByIP(i);
        -1 != e ? (e = m[e]).oProtocolInc.getDigitalChannelInfo(e, o).then(e => {
          t(e)
        }, e => {
          n(e)
        }) : n(_)
      ...
      return new Promise(function (t, n) {
        var e = this.findDeviceIndexByIP(i);
        -1 != e ? (e = m[e]).oProtocolInc.getZeroChannelInfo(e, o).then(e => {
          t(e)
        }, e => {
          n(e)
        }) : n(_)
      ...
      return new Promise(function (e, t) {
        var n = this.findDeviceIndexByIP(o), i = {iWndIndex: h, iStreamType: 1, iChannelID: 1, bZeroChannel: !1};
        g.extend(i, r), -1 != n ? (n = m[n], -1 == this.findWndIndexByIndex(i.iWndIndex) ? n.oProtocolInc.startRealPlay(n, i).then(function () {
          r.success && r.success(), e()
        }, function () {
          r.error && r.error(z), t(z)
        }) : t({errorCode: 3001, errorMsg: "The window is already playing."})) : (r.error && r.error(_), t(_))
      })
    }, this.I_StartPlay = function (o, r) {
      return new Promise(async function (e, t) {
        var n = this.findDeviceIndexByIP(o), i = {iWndIndex: h}, n = (g.extend(i, r), m[n]);
      ...
      return new Promise((t, e) => {
        p.JS_GetEncryptString(3, n).then(e => {
          t(e)
        }, () => {
          e(z)
        })
      ...
      return new Promise(async function (e, t) {
        var n, i = {iWndIndex: h},
          o = (g.isObject(r) ? g.extend(i, r) : g.isUndefined(r) || (i.iWndIndex = r), this.findWndIndexByIndex(i.iWndIndex));
        -1 != o ? ((n = I[o]).bRecord && p.JS_StopSave(n.iIndex), n.bSound && p.JS_CloseSound(), n.bEZoom && p.JS_DisableZoom(n.iIndex), p.JS_Stop(i.iWndIndex).then(() => {
      ...
      return o = g.isUndefined(o) ? h : o, new Promise((e, t) => {
        var n, i = this.findWndIndexByIndex(o);
        -1 == i || (n = I[i]).bSound ? t(z) : p.JS_OpenSound(o).then(() => {
          n.bSound = !0, e()
        }, () => {
          t(z)
        })
      ...
      return o = g.isUndefined(o) ? h : o, new Promise((e, t) => {
        var n, i = this.findWndIndexByIndex(o);
        -1 != i && (n = I[i]).bSound ? p.JS_CloseSound().then(() => {
          n.bSound = !1, e()
        }, () => {
          t(z)
        }) : t(z)
      ...
      return new Promise((e, t) => {
        n = parseInt(n, 10), isNaN(n) || n < 0 || 100 < n ? t(M) : (i = g.isUndefined(i) ? h : i, -1 != this.findWndIndexByIndex(i) ? p.JS_SetVolume(i, n).then(() => {
          e()
        }, () => {
          t(z)
        }) : t(z))
      ...
      return new Promise((e, t) => {
        ...
        g.isObject(o) ? g.extend(n, o) : g.isUndefined(o) || (n.iWndIndex = o), -1 != this.findWndIndexByIndex(n.iWndIndex) ? (".jpg" === i.slice(-4).toLowerCase() ? i = i.slice(0, -4) : ".jpeg" === i.slice(-5).toLowerCase() && (i = i.slice(0, -5)), p.JS_CapturePicture(n.iWndIndex, i, n.bDateDir).then(() => {
          e()
        }, () => {
          t(z)
        })) : t(z)
      ...
      return new Promise((t, n) => {
        ...
        g.isObject(i) ? g.extend(e, i) : g.isUndefined(i) || (e.iWndIndex = i), -1 != this.findWndIndexByIndex(e.iWndIndex) ? p.JS_GetCaptureData(e.iWndIndex).then(function (e) {
          t(e)
        }, function (e) {
          n(z)
        }) : n(z)
      ...
      return new Promise((e, t) => {
        var n, i = {iWndIndex: h, bDateDir: !0},
          o = (g.isObject(s) ? g.extend(i, s) : g.isUndefined(s) || (i.iWndIndex = s), this.findWndIndexByIndex(i.iWndIndex));
        -1 == o || (n = I[o]).bRecord ? (i.error && i.error(z), t(z)) : p.JS_StartSave(i.iWndIndex, r).then(function () {
      ...
      return new Promise((e, t) => {
        var n, i = {iWndIndex: h},
          o = (g.isObject(r) ? g.extend(i, r) : g.isUndefined(r) || (i.iWndIndex = r), this.findWndIndexByIndex(i.iWndIndex));
        -1 != o && (n = I[o]).bRecord ? p.JS_StopSave(i.iWndIndex).then(function () {
      ...
      return new Promise((e, t) => {
        var n, i;
        isNaN(parseInt(r, 10)) ? t(M) : -1 == (n = this.findDeviceIndexByIP(o)) || (i = m[n]).bVoiceTalk ? t(z) : i.oProtocolInc.startVoiceTalk(i, r).then(() => {
          m[n].bVoiceTalk = !0, e()
        }, () => {
          t(z)
        })
      ...
      return new Promise((n, e) => {
        p.JS_StopTalk().then(() => {
          for (var e = 0, t = m.length; e < t; e++) if (m[e].bVoiceTalk) {
            m[e].bVoiceTalk = !1;
            break
          }
          n()
      ...
      return new Promise((e, t) => {
        ...
        -1 == i || (r.szAuth = (n = m[i]).szAuth, n.bVoiceTalk) ? t(z) : n.oProtocolInc.audioPlay(r).then(() => {
          m[i].bVoiceTalk = !0, e()
        }, () => {
          t(z)
        })
      ...
      return new Promise((e, t) => {
        var n, i = {iWndIndex: h, iPTZIndex: r, iPTZSpeed: 4},
          o = (g.extend(i, a), this.findWndIndexByIndex(i.iWndIndex));
        -1 != o && (n = I[o], -1 != (o = this.findDeviceIndexByIP(n.szIP))) && (o = m[o], 9 == r ? o.oProtocolInc.ptzAutoControl(o, s, n, i).then(() => {
          e()
        }, e => {
          t(e)
      ...
      return new Promise((e, t) => {
        ...
        var n, i = this.findWndIndexByIndex(o);
        -1 != i ? (n = I[i]).bEZoom || p.JS_EnableZoom(o).then(() => {
          n.bEZoom = !0, e()
        }, () => {
          t(z)
        }) : t(z)
      ...
      return new Promise((e, t) => {
        o = g.isUndefined(o) ? h : o;
        var n, i = this.findWndIndexByIndex(o);
        -1 != i ? (n = I[i]).bEZoom ? p.JS_DisableZoom(o).then(() => {
          n.bEZoom = !1, e()
        }, () => {
          t(z)
        }) : e() : t(z)
      ...
      return new Promise((e, t) => {
        ...
        -1 != n ? ((n = I[n]).b3DZoom || (p.JS_SetDrawCallback(i, !0, "Rect", !1, function (e) {
          var t, n;
          e = e.points, -1 != (n = P.findWndIndexByIndex(h)) && (t = I[n], -1 != (n = P.findDeviceIndexByIP(t.szDeviceIdentify))) && (n = m[n]).oProtocolInc.set3DZoom(n, t, e, {})
        }), n.b3DZoom = !0), e()) : t(z)
      })
      ...
      return new Promise((e, t) => {
        i = g.isUndefined(i) ? h : i;
        var n = this.findWndIndexByIndex(i);
        -1 != n ? ((n = I[n]).b3DZoom && (p.JS_SetDrawCallback(i, !1, "Rect", !1, function () {
        }), n.b3DZoom = !1), e()) : t(z)
      })
      ...
      return new Promise(function (e, t) {
        var n, i = {iWndIndex: h, iPresetID: r}, o = (g.extend(i, s), this.findWndIndexByIndex(i.iWndIndex));
        -1 != o && (n = I[o], -1 != (o = this.findDeviceIndexByIP(n.szIP))) ? (o = m[o]).oProtocolInc.setPreset(o, n, i).then(() => {
          e()
        }, e => {
          t(e)
        }) : t(z)
      ...
      return new Promise(async function (e, t) {
        var n, i = {iWndIndex: h, iPresetID: r}, o = (g.extend(i, s), this.findWndIndexByIndex(i.iWndIndex));
        -1 != o && (n = I[o], -1 != (o = this.findDeviceIndexByIP(n.szIP))) ? (o = m[o]).oProtocolInc.goPreset(o, n, i).then(() => {
          e()
        }, e => {
          t(e)
        }) : t(z)
      ...
      return new Promise(async function (r, t) {
        ...
        -1 != e ? ((s = m[e]).szDeviceType !== T && s.szDeviceType !== D && s.szDeviceType !== w || (o = g.convertToUTCTime(o), a = g.convertToUTCTime(a)), e = {
          iChannelID: i,
          szStartTime: o,
          szEndTime: a,
          iSearchPos: 0,
          iStreamType: 1
        }, g.extend(e, d), e.success = null, s.oProtocolInc.recordSearch(s, e).then(e => {
          if (s.szDeviceType === T || s.szDeviceType === D || s.szDeviceType === w) for (var t, n, i = 0, o = $(e).find("searchMatchItem").length; i < o; i++) t = $(e).find("startTime").eq(i).text(), n = $(e).find("endTime").eq(i).text(), t = g.convertToLocalTime(t, s.iDeviceMinusLocalTime), n = g.convertToLocalTime(n, s.iDeviceMinusLocalTime), $(e).find("startTime").eq(i).text(t), $(e).find("endTime").eq(i).text(n);
      ...
      return new Promise(function (e, t) {
        var n = this.findDeviceIndexByIP(a), i = "", o = 1, r = 0, s = g.dateFormat(new Date, "yyyy-MM-dd"),
          s = {iWndIndex: h, iStreamType: 1, iChannelID: 1, szStartTime: s + " 00:00:00", szEndTime: s + " 23:59:59"};
        g.extend(s, d), -1 != n ? (i = (n = m[n]).oProtocolInc.CGI.startPlayback, r = s.iStreamType, o = 100 * s.iChannelID + r, g.extend(s, {
          urlProtocol: "rtsp://",
          cgi: i,
          iChannelID: o
        }), -1 == this.findWndIndexByIndex(s.iWndIndex) && (n.szDeviceType !== T && n.szDeviceType !== D && n.szDeviceType !== w || (s.szStartTime = g.convertToUTCTime(s.szStartTime), s.szEndTime = g.convertToUTCTime(s.szEndTime)), s.szStartTime = s.szStartTime.replace(/[-:]/g, "").replace(" ", "T") + "Z", s.szEndTime = s.szEndTime.replace(/[-:]/g, "").replace(" ", "T") + "Z", n.oProtocolInc.startPlayback(n, s).then(function () {
      ...
      return new Promise(function (e, t) {
        var n = this.findDeviceIndexByIP(a), i = "", o = -1, r = 0, s = g.dateFormat(new Date, "yyyy-MM-dd"),
          s = {iWndIndex: h, iStreamType: 1, iChannelID: 1, szStartTime: s + " 00:00:00", szEndTime: s + " 23:59:59"};
        g.extend(s, d), -1 != n && (n = m[n], parseInt(S.protocolType, 10), i = n.oProtocolInc.CGI.startPlayback, r = s.iStreamType, o = 100 * s.iChannelID + r, g.extend(s, {
          urlProtocol: "rtsp://",
          cgi: i,
          iChannelID: o
      ...
      return new Promise(async function (e, t) {
        var n, i = {iWndIndex: h},
          o = (g.isObject(r) ? g.extend(i, r) : g.isUndefined(r) || (i.iWndIndex = r), this.findWndIndexByIndex(i.iWndIndex));
        -1 != o && (2 == (o = (n = I[o]).iPlayStatus) || 4 == o) ? p.JS_FrameForward(i.iWndIndex).then(function () {
      ...
      return new Promise(async function (e, t) {
        var n = {iWndIndex: h},
          i = (g.isObject(s) ? g.extend(n, s) : g.isUndefined(s) || (n.iWndIndex = s), this.findWndIndexByIndex(n.iWndIndex));
        if (-1 != i) {
          var o = I[i], i = o.iPlayStatus, r = -1;
          if (2 == i) r = 3; else {
            if (5 != i) return n.error && n.error(z), void t(z);
            r = 6
          }
          p.JS_Pause(n.iWndIndex).then(function () {
      ...
      return new Promise(async function (e, t) {
        ...
        if (-1 != i) {
          ...
          p.JS_Resume(n.iWndIndex).then(function () {
            o.iPlayStatus = r, n.success && n.success(), e()
          }, function () {
            n.error && n.error(z), t(z)
          })
      ...
      return new Promise(async function (e, t) {
        var n = {iWndIndex: h},
          i = (g.isObject(o) ? g.extend(n, o) : g.isUndefined(o) || (n.iWndIndex = o), this.findWndIndexByIndex(n.iWndIndex));
        -1 != i && 2 == I[i].iPlayStatus ? p.JS_Slow(n.iWndIndex).then(function () {
      ...
      return new Promise(async function (e, t) {
        var n = {iWndIndex: h},
          i = (g.isObject(o) ? g.extend(n, o) : g.isUndefined(o) || (n.iWndIndex = o), this.findWndIndexByIndex(n.iWndIndex));
        -1 != i && 2 == I[i].iPlayStatus ? p.JS_Fast(n.iWndIndex).then(function () {
          n.success && n.success(), e()
        }, function () {
          n.error && n.error(z), t(z)
        }) : (n.error && n.error(z), t(z))
      ...
      return new Promise(async function (n, e) {
        var i = {iWndIndex: h};
        g.isObject(t) ? g.extend(i, t) : g.isUndefined(t) || (i.iWndIndex = t), -1 != this.findWndIndexByIndex(i.iWndIndex) ? p.JS_GetOSDTime(i.iWndIndex).then(function (e) {
          var t;
          i.success && (t = g.dateFormat(new Date(1e3 * e), "yyyy-MM-dd hh:mm:ss"), i.success(t)), n(t)
        }, function () {
      ...
      return new Promise((t, n) => {
        ...
        -1 != i ? (i = m[i], e = {
          ...
          szFileName: s + ".mp4",
          bDateDir: !0
        }, g.isUndefined(a) || g.extend(e, a), i.oProtocolInc.startDownloadRecord(i, e).then(e => {
          t(e)
        }, e => {
          n(e)
        })) : n(_)
      ...
      return new Promise((t, n) => {
        ...
        -1 != i && (i = m[i], e = {
          ...
          szFileName: s + ".mp4",
          bDateDir: !0
        }, g.isUndefined(c) || g.extend(e, c), i.oProtocolInc.startDownloadRecord(i, e).then(e => {
          t(e)
        }, e => {
          n(e)
        }))
      ...
      return new Promise((t, e) => {
        p.JS_GetDownloadStatus(n).then(e => {
          t(e)
        }, () => {
          e(z)
        })
      ...
      return new Promise((t, e) => {
        p.JS_GetDownloadProgress(n).then(e => {
          t(e)
        }, () => {
          e(z)
        })
      ...
      return new Promise((e, t) => {
        var n = this.findDeviceIndexByIP(i);
        -1 != n ? (n = m[n]).oProtocolInc.exportDeviceConfig(n).then(() => {
          e()
        }, () => {
          t(z)
        }) : t(_)
      ...
      return new Promise((e, t) => {
        var n = this.findDeviceIndexByIP(i);
        -1 != n ? (n = m[n]).oProtocolInc.importDeviceConfig(n, {szFileName: o}).then(() => {
          e()
        }, () => {
          t(z)
        }) : t(_)
      ...
      return new Promise((e, t) => {
        var n = {success: null, error: null}, i = (g.extend(n, s), this.findDeviceIndexByIP(o));
        -1 != i ? (i = m[i]).oProtocolInc.restore(i, r, n).then(() => {
          e()
        }, e => {
          t(e)
        }) : t(_)
      ...
      return new Promise((e, t) => {
        var n = {success: null, error: null}, i = (g.extend(n, r), this.findDeviceIndexByIP(o));
        -1 != i ? (i = m[i]).oProtocolInc.restart(i, n).then(() => {
          e()
        }, e => {
          t(e)
        }) : t(_)
      ...
      return new Promise((e, t) => {
        var n = {success: null, error: null}, i = (g.extend(n, r), this.findDeviceIndexByIP(o));
        -1 != i ? (i = m[i]).oProtocolInc.login(i.szIP, i.iCGIPort, i.szAuth, n).then(() => {
          e()
        }, e => {
          t(e)
        }) : t(_)
      ...
      return new Promise((e, t) => {
        var n = this.findDeviceIndexByIP(i);
        -1 != n ? (n = m[n]).oProtocolInc.startUpgrade(n, o).then(() => {
          e()
        }, () => {
          t(z)
        }) : t(_)
      ...
      return new Promise((t, e) => {
        this.I_SendHTTPRequest(n, f.CGI.startUpgrade.status, {}).then(e => {
      ...
      return new Promise((t, e) => {
        p.JS_CheckUpdate("<?xml version='1.0' encoding='utf-8'?><FileVersion><Platform name='win32'><localServiceControl>1.0.0.41</localServiceControl>").then(e => {
          t(e)
        }, () => {
          e(z)
        })
      ...
      return new Promise(async function (n, i) {
        var e = new R, t = "", o = "", r = this.findDeviceIndexByIP(s),
          r = (0 <= r && ("%" === a.substr(0, 1) && (a = a.substr(8)), t = (r = m[r]).szHttpProtocol + r.szIP + ":" + r.iCGIPort + "/" + a, o = r.szAuth), {
            type: "GET",
            url: t,
            auth: o,
            success: null,
        ...
        g.extend(r, d), e.submitRequest(r).then(function (t) {
          if (200 === t.httpStatusCode) {
            let e;
            e = 0 === t.httpResponse.indexOf("<?xml") ? g.loadXML(t.httpResponse) : JSON.parse(t.httpResponse), d.success && d.success(e), n(e)
      ...
      var t;
      return g.isUndefined(e) ? (g.extend(t = [], I), t) : -1 != (e = this.findWndIndexByIndex(e)) ? (g.extend(t = {}, I[e]), t) : null
      ...
      return new Promise((e, t) => {
        var n = [], i = g.formatPolygonXmlToJson(o);
        0 < i.aAddRect.length && n.push(p.JS_SetDrawShapeInfo("Rect", i.aAddRect[0])), 0 < i.aAddPolygon.length && n.push(p.JS_SetDrawShapeInfo("Polygon", i.aAddPolygon[0])), 0 < i.aRect.length && n.push(p.JS_SetRectInfo(i.aRect)), 0 < i.aPolygon.length && n.push(p.JS_SetPolygonInfo(i.aPolygon)), Promise.all(n).then(() => {
          e()
        }, () => {
          t(z)
        })
      ...
      return new Promise((t, e) => {
        var n = [];
        n.push(p.JS_GetPolygonInfo()), n.push(p.JS_GetRectInfo()), Promise.all(n).then(e => {
      ...
      return new Promise((t, n) => {
        ...
        r ? (i = [], o = [], r.forEach(e => {
          ...
          e = [];
          i.length && e.push(p.JS_ClearShapeByType("Polygon", i)), o.length && e.push(p.JS_ClearShapeByType("Rect", o)), Promise.all(e).then(() => {
            t()
          }, () => {
            n(z)
          })
      ...
      return new Promise((t, n) => {
        ...
        -1 != i ? (I[i], e = {
          ...
          success: s.success,
          error: s.error
        }, this.I_SendHTTPRequest((i = m[i]).szIP + "_" + i.iCGIPort, o, e).then(e => {
          t(e)
        }, e => {
          n(e)
        })) : n(_)
      ...
      if (-1 < e.indexOf("_")) {
        for (var t = 0, n = m.length; t < n; t++) if (m[t].szDeviceIdentify == e) return t
      } else for (t = 0, n = m.length; t < n; t++) if (m[t].szIP == e) return t;
      return -1
    }, this.findWndIndexByIndex = function (e) {
      for (var t = 0, n = I.length; t < n; t++) if (I[t].iIndex == e) return t;
      return -1
    };

    function A() {
      this.iIndex = 0, this.szIP = "", this.iCGIPort = 80, this.szDeviceIdentify = "", this.iChannelID = "", this.iPlayStatus = q, this.bSound = !1, this.bRecord = !1, this.bPTZAuto = !1, this.bEZoom = !1, this.b3DZoom = !1
    }
    ...
    R.prototype.submitRequest = function (e) {
      return e.method = this.getHttpMethod(e.type), e.content = e.data, delete e.type, delete e.data, p.JS_SubmitHttpRequest(e)
    ...
    n.prototype.CGI = {
      ...
      return new Promise(function (i, t) {
        var e = {};
        g.extend(e, r), g.extend(e, {
          success: function (e) {
            var t, n = H.$XML(e).find("audioCompressionType", !0);
            0 < n.length && (t = 0, "G.711ulaw" == (n = H.$XML(n).eq(0).text()) ? t = 1 : "G.711alaw" == n ? t = 2 : "G.726" == n ? t = 3 : "MP2L2" == n || "MPEL2" == n ? t = 4 : "G.722.1" == n ? t = 0 : "AAC" == n ? t = 5 : "PCM" == n ? t = 6 : "MP3" == n && (t = 7), o.iAudioType = t), "" !== H.$XML(e).find("audioBitRate").eq(0).text() ? o.m_iAudioBitRate = 1e3 * parseInt(H.$XML(e).find("audioBitRate").eq(0).text(), 10) : o.m_iAudioBitRate = 0, "" !== H.$XML(e).find("audioSamplingRate").eq(0).text() ? o.m_iAudioSamplingRate = 1e3 * parseInt(H.$XML(e).find("audioSamplingRate").eq(0).text(), 10) : o.m_iAudioSamplingRate = 0, "" !== H.$XML(e).find("channelNum").eq(0).text() ? o.m_iSoundChan = parseInt(H.$XML(e).find("channelNum").eq(0).text(), 10) : o.m_iSoundChan = 1, "" !== H.$XML(e).find("deviceCastChannelNum").eq(0).text() ? o.m_iDeviceAudioSoundChan = parseInt(H.$XML(e).find("deviceCastChannelNum").eq(0).text(), 10) : o.m_iDeviceAudioSoundChan = 1, r.success && r.success(e), i(e)
          }, error: function (e) {
      ...
      return new Promise(function (n, t) {
        var e = {};
        g.extend(e, o), g.extend(e, {
          success: function (e) {
            i.szDeviceType = H.$XML(e).find("deviceType").eq(0).text();
            var t = [];
            t.push("<DeviceInfo>"), t.push("<deviceName>" + g.escape(H.$XML(e).find("deviceName").eq(0).text()) + "</deviceName>"), t.push("<deviceID>" + H.$XML(e).find("deviceID").eq(0).text() + "</deviceID>"), t.push("<deviceType>" + H.$XML(e).find("deviceType").eq(0).text() + "</deviceType>"), t.push("<model>" + H.$XML(e).find("model").eq(0).text() + "</model>"), t.push("<serialNumber>" + H.$XML(e).find("serialNumber").eq(0).text() + "</serialNumber>"), t.push("<macAddress>" + H.$XML(e).find("macAddress").eq(0).text() + "</macAddress>"), t.push("<firmwareVersion>" + H.$XML(e).find("firmwareVersion").eq(0).text() + "</firmwareVersion>"), t.push("<firmwareReleasedDate>" + H.$XML(e).find("firmwareReleasedDate").eq(0).text() + "</firmwareReleasedDate>"), t.push("<encoderVersion>" + H.$XML(e).find("encoderVersion").eq(0).text() + "</encoderVersion>"), t.push("<encoderReleasedDate>" + H.$XML(e).find("encoderReleasedDate").eq(0).text() + "</encoderReleasedDate>"), t.push("</DeviceInfo>"), e = g.loadXML(t.join("")), o.success && o.success(e), n(e)
          }, error: function (e) {
      ...
      return new Promise(function (g, e) {
        P.I_SendHTTPRequest(S.szDeviceIdentify, f.CGI.time, {
          success: e => {
            ...
            if (8 === t.length) {
              var t = new Date(t[1], t[2] - 1, t[3], t[5], t[6], t[7]), e = $(e).find("timeZone").eq(0).text(), n = 0,
                i = e.indexOf("DST");
              if (-1 != i) {
                ...
                var I = parseInt(a.split(".")[0].replace("M", ""), 10),
                  f = (r.setMonth(I - 1), parseInt(a.split(".")[1], 10)), P = parseInt(a.split(".")[2].split("/")[0]),
      ...
      return new Promise(function (s, t) {
        var e = {};
        g.extend(e, d), g.extend(e, {
          success: function (e) {
            var t = [], n = (t.push("<VideoInputChannelList>"), H.$XML(e).find("VideoInputChannel", !0));
            a.iAnalogChannelNum = n.length;
            for (var i = 0, o = n.length; i < o; i++) {
              var r = n[i];
              t.push("<VideoInputChannel>"), t.push("<id>" + H.$XML(r).find("id").eq(0).text() + "</id>"), t.push("<inputPort>" + H.$XML(r).find("inputPort").eq(0).text() + "</inputPort>"), t.push("<name>" + g.escape(H.$XML(r).find("name").eq(0).text()) + "</name>"), t.push("<videoFormat>" + H.$XML(r).find("videoFormat").eq(0).text() + "</videoFormat>"), t.push("</VideoInputChannel>")
            }
        ...
        }), P.I_SendHTTPRequest(a.szDeviceIdentify, f.CGI.getAnalogChannelInfo, e)
      })
    }, n.prototype.getDigitalChannel = function (n, a) {
      return new Promise(function (s, t) {
        var e = {};
        g.extend(e, a), g.extend(e, {
          success: function (e) {
            for (var t = [], n = (t.push("<InputProxyChannelList>"), H.$XML(e).find("InputProxyChannel", !0)), i = 0, o = n.length; i < o; i++) {
              var r = n[i];
              t.push("<InputProxyChannel>"), t.push("<id>" + H.$XML(r).find("id").eq(0).text() + "</id>"), t.push("<name>" + g.escape(H.$XML(r).find("name").eq(0).text()) + "</name>"), t.push("</InputProxyChannel>")
            }
        ...
        }), P.I_SendHTTPRequest(n.szDeviceIdentify, f.CGI.getDigitalChannel, e)
      })
      ...
      return new Promise(async (a, t) => {
        ...
        for (var n = H.$XML(e).find("InputProxyChannel", !0), i = 0, o = n.length; i < o; i++) {
          var r = n[i], s = H.$XML(r).find("id").eq(0).text(), r = H.$XML(r).find("name").eq(0).text();
          d[s] = r
        }
        e = {};
        g.extend(e, u), g.extend(e, {
          success: function (e) {
            for (var t = [], n = (t.push("<InputProxyChannelStatusList>"), H.$XML(e).find("InputProxyChannelStatus", !0)), i = 0, o = n.length; i < o; i++) {
              var r = n[i], s = H.$XML(r).find("id").eq(0).text();
              t.push("<InputProxyChannelStatus>"), t.push("<id>" + s + "</id>"), t.push("<sourceInputPortDescriptor>"), t.push("<proxyProtocol>" + H.$XML(r).find("proxyProtocol").eq(0).text() + "</proxyProtocol>"), t.push("<addressingFormatType>" + H.$XML(r).find("addressingFormatType").eq(0).text() + "</addressingFormatType>"), t.push("<ipAddress>" + H.$XML(r).find("ipAddress").eq(0).text() + "</ipAddress>"), t.push("<managePortNo>" + H.$XML(r).find("managePortNo").eq(0).text() + "</managePortNo>"), t.push("<srcInputPort>" + H.$XML(r).find("srcInputPort").eq(0).text() + "</srcInputPort>"), t.push("<userName>" + g.escape(H.$XML(r).find("userName").eq(0).text()) + "</userName>"), t.push("<streamType>" + H.$XML(r).find("streamType").eq(0).text() + "</streamType>"), t.push("<online>" + H.$XML(r).find("online").eq(0).text() + "</online>"), t.push("<name>" + g.escape(d[s]) + "</name>"), t.push("</sourceInputPortDescriptor>"), t.push("</InputProxyChannelStatus>")
            }
        ...
        }), P.I_SendHTTPRequest(c.szDeviceIdentify, f.CGI.getDigitalChannelInfo, e)
      })
      ...
      0 != e.iAnalogChannelNum ? g.formatString(this.CGI.getStreamChannels.analog, e.szHttpProtocol, e.szIP, e.iCGIPort) : g.formatString(this.CGI.getStreamChannels.digital, e.szHttpProtocol, e.szIP, e.iCGIPort);
      let n;
      ...
      return new Promise(async function (t, e) {
        var n = 100 * a.iChannelID + a.iStreamType, i = "", o = g.delPort(s.szIP), r = s.iRtspPort;
        a.iPort && (r = a.iPort), i = a.bZeroChannel ? g.formatString(s.oProtocolInc.CGI.startRealPlay.zeroChannels, o, r, n) : g.formatString(s.oProtocolInc.CGI.startRealPlay.channels, o, r, n);
        await p.JS_SetSecretKey(0, S.secretKey, 1), p.JS_Play(i, {
          auth: s.szAuth,
          userInfo: s.szAuth
        }, a.iWndIndex, "", "", a.bFlag).then(() => {
          var e;
          (e = new A).iIndex = a.iWndIndex, e.szIP = s.szIP, e.iCGIPort = s.iCGIPort, e.szDeviceIdentify = s.szDeviceIdentify, e.iChannelID = a.iChannelID, e.iPlayStatus = 1, I.push(e), t()
        }, () => {
          e()
        })
      })
      ...
      return new Promise(async function (t, e) {
        p.JS_Play(i.szUrl, {auth: n.szAuth, userInfo: n.szAuth}, i.iWndIndex, i.startTime, i.endTime, !0).then(() => {
          var e;
          (e = new A).iIndex = i.iWndIndex, e.szIP = n.szIP, e.szDeviceIdentify = n.szDeviceIdentify, e.iPlayStatus = 2, I.push(e), t()
        }, () => {
          e()
        })
      })
    }, n.prototype.startVoiceTalk = function (e, t) {
      var n = g.formatString(this.CGI.startVoiceTalk.open, e.szHttpProtocol, e.szIP, e.iCGIPort, t),
        i = g.formatString(this.CGI.startVoiceTalk.close, e.szHttpProtocol, e.szIP, e.iCGIPort, t),
        t = g.formatString(this.CGI.startVoiceTalk.audioData, e.szHttpProtocol, e.szIP, e.iCGIPort, t);
      return p.JS_StartTalk(n, i, t, e.szAuth, e.iAudioType, e.m_iAudioBitRate, e.m_iAudioSamplingRate, e.m_iSoundChan, e.m_iDeviceAudioSoundChan)
      ...
      return new Promise((e, t) => {
        var n = r.iChannelID, n = (s.iPTZSpeed = s.iPTZSpeed < 7 ? 15 * s.iPTZSpeed : 100, o && (s.iPTZSpeed = 0), {
          type: "PUT",
          url: n <= i.iAnalogChannelNum ? g.formatString(f.CGI.ptzAutoControl.analog, i.szHttpProtocol, i.szIP, i.iCGIPort, r.iChannelID) : g.formatString(f.CGI.ptzAutoControl.digital, i.szHttpProtocol, i.szIP, i.iCGIPort, r.iChannelID),
          data: "<?xml version='1.0' encoding='UTF-8'?><autoPanData><autoPan>" + s.iPTZSpeed + "</autoPan></autoPanData>",
          success: null,
          error: null
        });
        g.extend(n, s), g.extend(n, {
          success: function () {
      ...
      var o = n.iChannelID,
        r = (n.bPTZAuto && this.ptzAutoControl(e, !0, n, {iPTZSpeed: 0}), i.iPTZSpeed = t ? 0 : i.iPTZSpeed < 7 ? 15 * i.iPTZSpeed : 100, [{}, {
          pan: 0,
          tilt: i.iPTZSpeed
        }, {pan: 0, tilt: -i.iPTZSpeed}, {pan: -i.iPTZSpeed, tilt: 0}, {pan: i.iPTZSpeed, tilt: 0}, {
          pan: -i.iPTZSpeed,
          tilt: i.iPTZSpeed
      ...
      t = {
        type: "PUT",
        url: o <= e.iAnalogChannelNum ? g.formatString(a.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, n.iChannelID) : g.formatString(a.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, n.iChannelID),
        data: s,
        success: null,
        error: null
      };
      ...
      var i = "", o = "",
        i = t.iChannelID <= e.iAnalogChannelNum ? g.formatString(this.CGI.setPreset.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID, n.iPresetID) : g.formatString(this.CGI.setPreset.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID, n.iPresetID),
        t = (o = (o = "<?xml version='1.0' encoding='UTF-8'?>") + "<PTZPreset>" + ("<id>" + n.iPresetID + "</id>"), e.szDeviceType != D && (o += "<presetName>Preset" + n.iPresetID + "</presetName>"), {
          type: "PUT",
          url: i,
          data: o += "</PTZPreset>",
          success: null,
      ...
      t = {
        type: "PUT",
        url: t.iChannelID <= e.iAnalogChannelNum ? g.formatString(this.CGI.goPreset.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID, n.iPresetID) : g.formatString(this.CGI.goPreset.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID, n.iPresetID),
        success: null,
        error: null
      };
      return g.extend(t, n), P.I_SendHTTPRequest(e.szDeviceIdentify, "", t)
      ...
      return new Promise((s, t) => {
        var e = d.iChannelID, n = d.iStreamType, i = d.szStartTime.replace(" ", "T") + "Z",
          ...
          r = g.formatString(f.CGI.recordSearch, a.szHttpProtocol, a.szIP, a.iCGIPort),
        ...
        g.extend(n, d), g.extend(n, {
          success: function (e) {
            for (var t = [], n = (t.push("<CMSearchResult>"), t.push("<responseStatus>" + H.$XML(e).find("responseStatus").eq(0).text() + "</responseStatus>"), t.push("<responseStatusStrg>" + H.$XML(e).find("responseStatusStrg").eq(0).text() + "</responseStatusStrg>"), t.push("<numOfMatches>" + H.$XML(e).find("numOfMatches").eq(0).text() + "</numOfMatches>"), t.push("<matchList>"), H.$XML(e).find("searchMatchItem", !0)), i = 0, o = n.length; i < o; i++) {
              var r = n[i];
              t.push("<searchMatchItem>"), t.push("<trackID>" + H.$XML(r).find("trackID").eq(0).text() + "</trackID>"), t.push("<startTime>" + H.$XML(r).find("startTime").eq(0).text() + "</startTime>"), t.push("<endTime>" + H.$XML(r).find("endTime").eq(0).text() + "</endTime>"), t.push("<playbackURI>" + g.escape(H.$XML(r).find("playbackURI").eq(0).text()) + "</playbackURI>"), t.push("<metadataDescriptor>" + H.$XML(r).find("metadataDescriptor").eq(0).text().split("/")[1] + "</metadataDescriptor>"), t.push("</searchMatchItem>")
            }
            t.push("</matchList>"), t.push("</CMSearchResult>"), e = g.loadXML(t.join("")), d.success && d.success(e), s(e)
          }, error: function (e) {
            d.error && d.error(e), t(e)
          }
      ...
      return new Promise(async function (t, e) {
        var n = c.iWndIndex, i = c.szStartTime, o = c.szEndTime, r = g.delPort(d.szIP), s = d.iRtspPort;
        if (c.iPort && (s = c.iPort), r = g.formatString(c.cgi, r, s, c.iChannelID), !g.isUndefined(c.oTransCodeParam)) {
          s = c.oTransCodeParam, a = {TransFrameRate: "", TransResolution: "", TransBitrate: ""}, g.extend(a, s);
        ...
        p.JS_Play(r, {auth: d.szAuth, userInfo: d.szAuth}, n, i, o, c.bFlag).then(() => {
          var e;
          (e = new A).iIndex = n, e.szIP = d.szIP, e.iCGIPort = d.iCGIPort, e.szDeviceIdentify = d.szDeviceIdentify, e.iChannelID = c.iChannelID, e.iPlayStatus = 2, I.push(e), t()
        }, () => {
          e()
        })
      })
      ...
      return new Promise(function (t, e) {
        var n = d.iWndIndex, i = d.szStartTime, o = d.szEndTime, r = g.delPort(a.szIP), s = a.iRtspPort,
          r = (d.iPort && (s = d.iPort), g.formatString(d.cgi, r, s, d.iChannelID));
        p.JS_ReversePlay(r, {auth: a.szAuth, userInfo: a.szAuth}, n, i, o).then(() => {
          var e = new A;
          e.iIndex = n, e.szIP = a.szIP, e.iCGIPort = a.iCGIPort, e.szDeviceIdentify = a.szDeviceIdentify, e.iChannelID = d.iChannelID, e.iPlayStatus = 5, I.push(e), t()
        }, () => {
          e()
        })
      })
    }, n.prototype.startDownloadRecord = function (e, t) {
      var n = g.formatString(this.CGI.startDownloadRecord, e.szHttpProtocol, e.szIP, e.iCGIPort),
        i = "<?xml version='1.0' encoding='UTF-8'?><downloadRequest><playbackURI>" + g.escape(t.szPlaybackURI) + "</playbackURI></downloadRequest>";
      return p.JS_StartAsyncDownload(n, e.szAuth, t.szFileName, i, t.bDateDir)
    }, n.prototype.exportDeviceConfig = function (e) {
      var t = g.formatString(this.CGI.downloaddeviceConfig, e.szHttpProtocol, e.szIP, e.iCGIPort);
      return p.JS_DownloadFile(t, e.szAuth, "", 0)
    }, n.prototype.importDeviceConfig = function (e, t) {
      var n = g.formatString(this.CGI.uploaddeviceConfig, e.szHttpProtocol, e.szIP, e.iCGIPort);
      ...
      t = g.formatString(this.CGI.restore, e.szHttpProtocol, e.szIP, e.iCGIPort, t);
      ...
      var n = g.formatString(this.CGI.startUpgrade.upgrade, e.szHttpProtocol, e.szIP, e.iCGIPort);
      g.formatString(this.CGI.startUpgrade.status, e.szHttpProtocol, e.szIP, e.iCGIPort);
      return p.JS_StartUpgrade(n, "", e.szAuth, t)
    }, n.prototype.set3DZoom = function (e, t, n, i) {
      var o = "",
        o = t.iChannelID <= e.iAnalogChannelNum ? g.formatString(this.CGI.set3DZoom.analog, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID) : g.formatString(this.CGI.set3DZoom.digital, e.szHttpProtocol, e.szIP, e.iCGIPort, t.iChannelID),
      ...
      var t = 100 * t + 1, e = g.formatString(this.CGI.deviceCapture.channels, e.szHttpProtocol, e.szIP, e.iCGIPort, t),
        t = [];
      g.isInt(i.iResolutionWidth) && t.push("videoResolutionWidth=" + i.iResolutionWidth), g.isInt(i.iResolutionHeight) && t.push("videoResolutionHeight=" + i.iResolutionHeight), 0 < t.length && (e += "?" + t.join("&"));
    ...
    return W.prototype.extend = function () {
      ...
      var e = "";
      if ("" !== s.szBasePath) e = s.szBasePath; else {
      ...
      return $(e).find("SnapPolygon").each(function () {
        var e = parseInt($(this).find("EditType, editType").text(), 10) || 0,
          t = "true" === $(this).find("isClosed").text(), n = parseInt($(this).find("polygonType").text(), 10),
      ...
      var n = (e = e.replace("T", " ").replace("Z", "")).split(" ")[0].split("-"), i = parseInt(n[0], 10),
        o = parseInt(n[1], 10) - 1, n = parseInt(n[2], 10), e = e.split(" ")[1].split(":"), r = parseInt(e[0], 10),
        s = parseInt(e[1], 10), e = parseInt(e[2], 10), i = new Date(Date.UTC(i, o, n, r, s, e));
